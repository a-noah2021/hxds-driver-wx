<template>
  <view>
    ...
    <u-cell-group>
      ...
      <u-cell-item icon="red-packet-fill" title="停车费" :value="parkingFee + '元'"
                   @click="enterFee('parking')"></u-cell-item>
      <u-cell-item icon="red-packet-fill" title="其他费用" :value="otherFree + '元'"
                   @click="enterFee('other')"></u-cell-item>
    </u-cell-group>
